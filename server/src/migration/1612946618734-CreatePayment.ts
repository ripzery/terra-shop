...
export class CreatePayment1612946618734 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "payment" ADD "created_at" TIMESTAMP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "payment" ADD "updated_at" TIMESTAMP NOT NULL`);
    }
